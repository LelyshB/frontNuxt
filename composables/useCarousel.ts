...
/**
 * Provides carousel behaviour for components like the Services carousel.
 * Handles auto‑play, pause on hover and keyboard navigation.  The
 * returned object exposes reactive `currentIndex` and helper methods
 * for navigation.
 */
