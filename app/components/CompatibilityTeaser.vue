<template>
  <!-- A teaser section allowing the user to input two birth dates and
       visualising the compatibility score along an arc. -->
  <section class="py-16 px-4" id="compat">
    <div class="container mx-auto max-w-4xl">
      ...
      <div class="flex flex-col items-center space-y-8">
        ...
        >
          <!-- Connection Arc with gradient stroke -->
          ...
          <div
            ...
            :class="{ 'animate-pulse': !motionReduced && !isPaused, 'hover:scale-110': true }"
            :style="{
...
const floatY = ref(0)
const compatibilityScore = ref(87) // demonstration value

// Colour constants for the gradient used on the arc
const amethystHsl = '255 92% 64%'
const auroraTealHsl = '172 78% 57%'

// Floating particles along the arc; you can tweak these values
const particles = ref([
...
const checkCompatibility = () => {
  // Placeholder for compatibility logic; this would normally call an API
