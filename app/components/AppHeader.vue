<template>
  <!-- Site header.  The header becomes slightly more compact once the
       page is scrolled.  On small screens a hamburger menu toggles a
        ...
        <div class="flex items-center justify-between">
          ...
          <NuxtLink to="/" class="flex items-center gap-3 group">
            <div class="relative">
              ...
              <div class="absolute -inset-2">
                ...
                <div
                  class="w-0.5 h-0.5 bg-violet rounded-full absolute top-1 right-0 animate-pulse"
                  style="animation-delay: 0.5s;"
                ></div>
                <div
                  class="w-0.5 h-0.5 bg-magenta rounded-full absolute bottom-0 left-1 animate-pulse"
          ...
          <div class="hidden md:flex items-center gap-8">
            ...
            >
              ...
              <!-- Active indicator -->
              <div
                class="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-violet to-magenta scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left"
              ></div>
            </NuxtLink>
          </div>
...
// The header relies on a handful of small icons which are resolved
// dynamically using Vue's `resolveComponent`.  The `NuxtLink`
// component is globally available within a Nuxt application.
