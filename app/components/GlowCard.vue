<template>
  <!-- A card component with an animated glow effect around it.  The
       intensity of the glow can be controlled via the
       `glowIntensity` prop.  Content is passed through a default
       slot. -->
  <div
  ...
  >
    ...
    <!-- Card surface -->
    <div
      class="relative glass-surface rounded-2xl transform-gpu transition-all duration-200 ease-cosmic"
    ...
    >
      ...
      <div
        ...
        style="background: var(--gradient-cosmic); padding: 1px;"
      >
