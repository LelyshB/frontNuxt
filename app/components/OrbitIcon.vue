<template>
  <!-- An icon surrounded by a rotating orbital ring.  The size can be
       controlled via the `size` prop and any icon name from our
       collection can be passed via `iconName`. -->
  <div class="relative" :class="className">
    ...
    >
      <!-- Orbital dot -->
      <div
        class="absolute w-1 h-1 bg-gradient-to-r from-violet to-magenta rounded-full shadow-glow-violet -top-0.5 left-1/2 transform -translate-x-1/2"
      />
    </div>
    <!-- Icon container -->
