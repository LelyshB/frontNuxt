<template>
  <!-- A single zodiac badge used in the full zodiac grid.  The badge
       fades in when it enters the viewport. -->
  <div
    ref="badgeRef"
    class="group relative p-6 glass-surface rounded-2xl transform-gpu transition-all duration-200 ease-cosmic hover:scale-[1.02] hover:shadow-glow-violet opacity-0 translate-y-8"
